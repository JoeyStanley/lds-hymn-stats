...
description: "This post shows what the most common hymns are overall in LDS sacrament meetings."
author: "Joey Stanley"
date: "9/8/23"
...
freqs %>%
    ...
    cleveland_plot(filter_n = 374, extra_cols = is_sacrament, color = is_sacrament, base_size = 10,
                   title = "Hymns sung more than once per year per ward, on average",
                   subtitle = NULL) + 
...
This figure shows nice list of 24 hymns that are probably well-known by most members of the church, like <hymn>I Know That My Redeemer Lives (#136)</hymn>, <hymn>How Firm a Foundation (#85)</hymn>, and <hymn>Because I Have Been Given Much (#219)</hymn>. They are generic enough to be appropriate for most meetings. Their message is centered on Christ and other foundation tenents of our religion. Some are more common around certain holidays, like <hymn>Come, Come Ye Saints (#30)</hymn> around Pioneer Day in Utah or <hymn>Love At Home (#294)</hymn> around Mother's Day, but they're also general enough to be appropriate at other times of the year as well. Thus, what we see in the figure above is a solid list of the most popular hymns in the Church of Jesus Christ of Latter-day Saints.
...
This list of favorites is useful because if you are a new ward organist, these are the hymns to practice first. Learning these 24 hymns (plus the sacrament hymns) will get you the most mileage. In fact, these 49 hymns account for 44.3% of the hymns sung in sacrament meeting in this sample. That means that if you learn the hymns shown in the figure above, you'll be able to play almost half of the meetings in your ward.
