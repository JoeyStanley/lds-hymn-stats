...
sd(bootstrapped$n_unique_hymns_mean)
```
...
The average is around 105, but that doesn't mean all wards were close to that. 50% of wards were between about 97 and 111 hymns per year. Others do more and others do fewer. If you're not sure whether your ward has enough variety, count the number of unique hymns in a 1-year period and if it's in the low 100s, you're doing alright.  
...
Here is a plot that shows this trend across time, that might shed a little light on these numbers. Since I have data spanning over 20 years, we can see a long period of stability prior to 2019. Covid definitely disrupted the status quo; many ward only sang just one hymn as they resumed in-person meetings. However, 2019 numbers look pretty similar to the years before it. And there has been a noticeable increase since 2021. Only recently does it look to be as high as the pre-2019 era. 
...
So, do we have fewer intermediate hymns since we shifted to two-hour church? Yes, but I think it's because of covid than the length of sacrament meeting.