...
```{r, warning = FALSE, message = FALSE, include = TRUE, fig.height = 4, fig.width = 6.5}
fathers_pre2024 |> 
    filter(!hymn_num %in% 169:197) |>
    cleveland_plot(n_weeks = 1, filter_n = 5, breaks = 0.1) + 
...
It's clear from this plot that there are two Father's Day hymns that stand out as being the most common: <hymn>O My Father (#292)</hymn> and <hymn>Our Father, by Whose Name (#296)</hymn>. Because Primary children typically sing a Father's Day song, the number of intermediate hymns is lower than on other weeks. Only about 17% of wards sing an intermediate hymn on Father's Day, as opposed to the overall average of about 35%. So, for many wards, these two hymns are the opening and closing hymns. 

However, a smaller proportion of wards sing other hymns. They fall into a few broad categories: Home/Family, Heavenly Father, and to a much smaller extent, Work. 
