...
A noteworthy landmark is that October 26 was the day where the most number of wards sang at least one new hymn: about 55%. We've seen a handful of weeks were right around half of wards sang new hymns, but that day was quite a bit more than others. We hit this number again on November 30, presumably as many wards started to sing the new Christmas hymns.
...
Since the data is still so sparse, it's important to to put too much weight into the percentages. But it is clear that <hymn>Our Prayer to Thee (#1048)</hymn> is the lion's share of fifth batch hymns, at least for the first few weeks. Something we're seeing though is that two other hymns, <hymn>Thou Gracious Lord, Whose Mercy Lends (#1042)</hymn> and <hymn>Help Us Remember (#1043)</hymn> have become more common recently, with roughly a quarter to a third of wards that have sung fifth-batch hymns singing them. And in the fifth week, we're starting to see the other less common ones being used more too. Now that we're in the Christmas season, <hymn>Go Tell It on the Mountain (#1208) is more common.
...
That's all for now. We're starting to see the fifth batch pick up in popularity a little bit, which is exciting. I expect we'll see Christmas affect things quite a bit, and then I think we're due for another batch in January. 
