...
The following plot shows the estimated number of times each Christmas hymn is estimated to have been sung per ward this year. Yes, some are over 1.0 because some wards have sung them more than once, so they average out to be greater than one! Less than about 20% of wards have sung <hymn>While Shepherds Watched Their Flocks (#211)</hymn>. 
...
The following plot shows hymns in order of of how much more or less they were sung in 2024 compared to all the previous years I have data for. The way you read it is this: if the number is positive, it means the hymn was that much more common this year (e.g. "Silent Night was almost 30% more common in 2024") but if it's negative, it means the hymn was that much less common this year (e.g. "While Shepherds Watched Their Flocks was almost 50% less common, or rather, half as common, in 2024").
...
diffs_2024 |> 
    ...
    scale_x_continuous(breaks = seq(-0.5, 0.5, 0.1), 
                       labels = percent,
                       expand = expansion(0, c(0.45, 0.05))) + 
