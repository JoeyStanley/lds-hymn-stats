...
I've split the data up by month because I thought there might be a difference, and it turns out I was right. <hymn>Come, Let Us Anew (#217)</hymn> is about equally likely to be sung as an opening hymn or a closing hymn, regardless of whether it's before New Year's or after, with maybe a slight preference for it as an opening hymn in January. But <hymn>Ring Out, Wild Bells (#215)</hymn> is far more common as a closing hymn in December and as an opening hymn in January. [Once again, a $\chi^2$ test suggests that this difference in when <hymn>Ring Out, Wild Bells (#215)</hymn> is sung in the meeting is statistically significant ($\chi^2$ = 24.21, df = 1, *p* < 0.001).]{.aside} I think the general idea is that New Year's hymns are most common in the slot closest to New Year's itself, so since closing hymns in December are closer to New Year's, you sing them last, and since opening hymns are closer in January, you sing them as opening hymns. 
