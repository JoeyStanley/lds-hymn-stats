...
It's apparent that it is quite popular to sung New Year's hymns the Sunday after Christmas. Over 45% of wards sing <hymn>Come, Let Us Anew (#217)</hymn> and about 39% sing <hymn>Ring Out, Wild Bells (#215)</hymn>. There is also a clear stand out for the most most popular Christmas hymn during this week, which is <hymn>I Heard the Bells on Christmas Day (#215)</hymn>, but only about 15% of wards sing it the Sunday after Christmas. 
...
limbo %>%
    ...
    mutate(holiday = case_when(hymn_num %in% christmas_hymns ~ "Christmas",
                               ...
                               TRUE ~ "Other"),
           holiday = factor(holiday, levels = c("Christmas", "New Year's", "Other"))) %>%
    cleveland_plot(title = "Hymns sung betwen December 26th and Decemnber 31st ", 
                   subtitle = "There are only of <span style = 'color:#4477AA;'>New Year's</span> and <span style = 'color:#EE6677;'>Christmas</span>; no <span style = 'color:#777777;'>Other</span> hymn were popular.",
...
Let's dive just a little bit deeper into just the Sunday after Christmas, @tbl-n_of_each shows the percentage of wards in my sample that sing Christmas and New Year's hymns the Sunday after Christmas The top right cell shows that 33.08% of wards sing at least one Christmas hymn and no New Year's hymns. The bottom left cell shows that 31.18% of wards sing at least one New Year's hymn and no Christmas hymns. It is interesting that these numbers are almost even, so even though the two blue bars in @fig-limbo above were much longer, the many shorter red bars add up to be about the same. 
...
Interestingly, the numbers in the other corners of the box are also pretty even. About 18.25% of wards sing both Christmas and New Year's hymns, while 17.49% of wards sing neither. And if we add up the rows and the columns, they all come close to about 50%. Here's a (maybe confusing) summary of what's happening:
...
Among the New Year's hymns, we again see that <hymn>Ring Out, Wild Bells (#215)</hymn> is more common in December and that <hymn>Come, Let Us Anew (#217)</hymn> is more common in January.[A $\chi^2$ test suggests that this difference---that <hymn>Ring Out, Wild Bells (#215)</hymn> is more common before New Year's and <hymn>Come, Let Us Anew (#217)</hymn> is more common after---is statistically significant ($\chi^2$ = 7.179, df = 1, *p* = 0.007). This may be another case where the order that they appear in the hymnal influences when they're sung.]{.aside} Among the Christmas hymns, there's nothing that really stands out. Each hymn has its own story of course, but it's nothing that we haven't already seen when looking at [Christmas hymns over the course of December](/posts/christmas).
...
I've split the data up by month because I thought there might be a difference, and it turns out I was right. <hymn>Come, Let Us Anew (#217)</hymn> is about equally likely to be sung as an opening hymn or a closing hymn, regardless of whether it's before New Year's or after, with maybe a slight preference for it as an opening hymn in January. But <hymn>Ring Out, Wild Bells (#215)</hymn> is far more common as a closing hymn in December and as an opening hymn in January. [Once again, a $\chi^2$ test suggests that this difference in when <hymn>Ring Out, Wild Bells (#215)</hymn> is sung in the meeting is statistically significant ($\chi^2$ = 24.21, df = 1, *p* < 0.001).]{.aside}
...
Christmas hymns are less common the further you are from Christmas. New Year's hymns are common the closer you are to New Year's. Specifically, <hymn>Ring Out, Wild Bells (#215)</hymn> is more common in December and <hymn>Come, Let Us Anew (#217)</hymn> is more common in January. Other hymns gradually become more and more common so that by the time the twelve days of Christmas are over, almost all congregations have transitioned completely away from either holiday. 