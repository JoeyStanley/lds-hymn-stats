...
description: "Which key signatures are the most common and why? Which ones are people most likely to see? What hymns are in a minor key?"
author: "Joey Stanley"
date: 9-16-2023
...
```{r, include = TRUE, fig.height = 3, fig.width = 9}
#| label: fig-sopranos
#| fig-cap: "Soprano ranges for two representative hymns"
...
```{r, include = TRUE, fig.height = 3, fig.width = 9, warning=FALSE}
#| label: fig-basses
#| fig-cap: "Bass ranges for two representative hymns"
...
freqs %>%
    filter(hymn_num %in% c(198, 215, 284, 162, 126)) %>%
    cleveland_plot(x_buffer = 0.2, breaks = 0.1,
                   title = "Hymns set in a minor key", 
                   subtitle = NULL)
```
