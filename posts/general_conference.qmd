...
description: "General Conference is next week and many wards will be singing hymns about it. Of course, no one has sacrament meeting on General Conference Sunday, but many wards \"celebrate\" it by singing hymns the Sunday before. Let's take a look at what those hymns are and what patterns we can uncover."
author: "Joey Stanley"
date: "9/23/23"
categories:
  - frequency
...
The two most typical General Conference hymns are <hymn>We Thank Thee, O God, for a Prophet (19)</hymn> and <hymn>Come, Listen to a Prophet's Voice (21)</hymn>.
:::
...
![Annual trends of General Conference hymns.](../images/genconf_annual.jpeg){#fig-genconf_annual}
...
We should give this a new title and/or a new first verse. I think it's appropriately placed in the "restoration" section of the hymnal, but I think it should be moved further from "prophets" subsection.
:::

::: {.callout-tip icon="false"}
#### Recommendation for music chairpeople
...
The second interesting thing I see in @fig-genconf_annual is something we'll see with other holidays too: music chairpeople choose the less popular hymns further from the holiday itself and the more popular ones closer to the holiday. Looking at October, we see that the largest spike in the entire figure is for <hymn>We Thank Thee, O God, for a Prophet (19)</hymn> the week before conference. Meanwhile, <hymn>Come, Listen to a Prophet's Voice (21)</hymn> actually has a drop during that same week. It seems like music chairpeople don't want to "waste" a "good" hymn on a less-than-ideal week.
...
![When during sacrament meeting are General Conference hymns sung?](../images/genconf_by_type.jpeg){#fig-genconf_by_type}
...
![An even deeper look into when these hymns are sung in sacrament meeting by week](../images/genconf_by_type_by_week.jpeg){#fig-genconf_by_type_by_week}
...
![Annual trends of other prophet-related hymns.](../images/genconf_annual_others.jpeg){#fig-genconf_annual_others}
