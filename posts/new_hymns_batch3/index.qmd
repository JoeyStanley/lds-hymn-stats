...
labels <- tibble(
    ...
    date  = ymd(c("2025-02-08", "2025-02-14", "2024-12-15", "2025-02-04")),
...
I've now seen all the new hymns sung at least once in my dataset. <hymn>Let Easter Anthems Ring (#1205)</hymn> has been sung the most in this batch, but that's only because of [Easter](/posts/easter2025). If we ignore that one, it looks like <hymn>Softly and Tenderly Jesus Is Calling (#1020)</hymn> is currently the most popular of the new hymns generally. It's followed by <hymn>This Little Light of Mine (#1028)</hymn> and then <hymn>I Know That the Savior Loves Me (1021)</hymn>, but we'll likely see this change a little bit over the next few weeks and months. 

(For a complete version of this table that includes all hymns, see [here](/overview.qmd).)

## What hymns are most popular each week?

Even though still relatively few wards have sung from the third batch, we can start to get an idea of what hymns were popular when *of the wards that sang them*. 
