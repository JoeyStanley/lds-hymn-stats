...
I've now seen all the new hymns sung at least once in my dataset. It looks like <hymn>Softly and Tenderly Jesus Is Calling (#1020)</hymn> is currently the most popular of the new hymns. It's followed by <hymn>This Little Light of Mine (#1028)<hymn> and then <hymn>I Know That the Savior Loves Me (1021)</hymn>, but we'll likely see this change a little bit over the next few weeks and months. 
...
Now that it's been over a month, we can start to see some patterns. It seems like the most popular hymns are somewhat erratic: <hymn>Softly and Tenderly Jesus Is Calling (#1020)</hymn>, <hymn>I Know That My Savior Loves Me (#1021)</hymn>, and <hymn>This Little Light of Mine (#1028)</hymn> jump around a lot for some reason. It's likely a sample size issue, again because so few wards are singing them. Some of the less common ones don't show a clear pattern, other than they're generally present but not common. Some become slightly more popular after a few weeks, again suggesting (like the other batches) that once wards have gotten the favorites out of the way, they are then open to trying new ones. Most notable, <hymn>Let Easter Anthens Ring (#1205)</hymn> is increasing 

I'm a little surprised that there aren't too many clear patterns. It might be a sample size issue: less data means proportional data like this is more erratic. But, a few hymns seem to be steadily increasing in popularity. But, we'll have to wait for more time to pass and more wards to sing these hymns before we can say much for sure.
...
It's hard to say too much about the third batch of hymns because not too many wards have sung those hymns so far. We're starting to see which are more popular than others and when they're sung during the meeting. What is clear though is the relatively cold reception these hymns have gotten. After a month, still only a small proportion of wards have sung from this third batch. But, the past two weeks have shown some signs of greater use. As we approach Easter, we might see more and more wards singing these new hymns.
