...
We got new hymns this week and today was the first chance to use them! Between social media and personal connections, I was able to collect hymn data from 74 wards. Let's see how these new hymns were introduced into these wards!

::: callout-note
Note that this blog post will update as I collect more data. I collected data from 54 wards on June 2, but it has grown since then, which gives a more accurate view of what happened. 
:::
...
tom_anderson_data |> 
    ...
    gt() |> 
    tab_header(title = "What new hymns were sung on June 2, 2024",
               subtitle = paste("Based on", n_wards_that_sang_new + n_tom_anderson, "wards that sang new hymns"))
```
