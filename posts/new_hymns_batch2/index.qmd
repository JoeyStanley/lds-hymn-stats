...
But first, here's how much data I have for each week, just so you have an idea of what I'm working with. For what it's worth, I have more data from each of the past few weeks than any other week in my entire dataset.
...
What is perhaps more interesting though is not which batch people sang from, but whether they sang any new hymns at all. Look at the blue lines. Those represent the number of wards singing new hymns total, across both batches. They have gone up over the past few weeks. To accompany that, the gray line, which represents the number of wards that sang none of the new hymns, goes down. Most recently, on October 20th, almost half of the wards I have data from sang at least one of the new hymns!
...
So, perhaps unsurprisingly, <hymn>Amazing Grace (#1010)</hymn> is far and away the most popular in this batch. A distant second is <hymn>My Shepherd Will Supply My Need (#1014)</hymn> and third is <hymn>This Is the Christ (#1017)</hymn>. 
...
So, <hymn>Amazing Grace (#1010)</hymn> has taken the lion's share of the new hymns. In the first four weeks, if a ward sang any from the second batch, about half of the time that hymn was <hymn>Amazing Grace (#1010)</hymn>. But it has waned slightly and other hymns have gotten more popular. Perhaps now that some wards have gotten it out of the way, they've freed themselves up to sing others. There aren't really any other patterns in the hymns over time.
...
Looks like <hymn>Amazing Grace (#1010)</hymn> is about split between being an opening hymn or a closing hymn, with the possibility of an intermediate hymn being about half as likely. <hymn>My Shepherd Will Supply My Need (#1014)</hymn> is pretty even across all three non-sacrament slots and <hymn>This Is the Christ (#1017)</hymn> is about even across all four slots in a sacrament meeting. 

The other hymns show some patterns but because I've seen them far less often, I have to take these distributions with a grain of salt. It looks like some hymns are most likely to be intermediate hymns, like <hymn>Anytime, Anywhere (#1012)</hymn>, <hymn>God's Gracious Love (#1013)</hymn>, and <hymn>Come, Lord Jesus (#1018)</hymn>. <hymn>Oh, the Deep, Deep Love of Jesus (#1015)</hymn> is more common towards the end of the meeting, while <hymn>Behold the Wounds in Jesus' Hands (#1016)</hymn> is most common at the beginning. Finally, <hymn>Holding Hands Around the World (#1011)</hymn> shows an interesting distrubiton of being sung in all fours slots, but with different frequencies for each one. 
...
However, we're now five weeks since the release of the second batch, and it's clear that people are warming up to them. I believe we're at the cusp of their peak popularity. I predict that in the next couple of weeks, we'll see more than half of wards singing at least one new hymn. Once we get into Thanksgiving (in the US) and Christmas, those holidays will take precedent and we'll see fewer new hymns (except of course the new Christmas ones). In January, once the next batch is scheduled to come out, I think we'll see that third batch becoming more popular than either of the other two for a while.
