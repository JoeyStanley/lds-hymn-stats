...
So, <hymn>Amazing Grace (#1010)</hymn> has taken the lion's share of the new hymns. In the first four weeks, if a ward sang any from the second batch, about half of the time that hymn was <hymn>Amazing Grace (#1010)</hymn>. But it has waned a bit since the initial release, and other hymns have gotten more popular. Perhaps now that some wards have gotten it out of the way, they've freed themselves up to sing others. This is similar to [what we saw](/posts/new_hymns_batch1) with <hymn>Come, Thou Fount of Every Blessing (#1001)</hymn>, though in a less extreme way. As far as I can tell, There aren't really any other patterns in the hymns over time.
...
However, we're now six weeks since the release of the second batch, and it's clear that people are warming up to them. I believe we're at the cusp of their peak popularity. I predict that in the next couple of weeks, we'll see more than half of wards singing at least one new hymn. Once we get into Thanksgiving (in the US) and Christmas, those holidays will take precedent and we'll see fewer new hymns (except of course the new Christmas ones). In January, once the next batch is scheduled to come out, I think we'll see that third batch becoming more popular than either of the other two for a while.
