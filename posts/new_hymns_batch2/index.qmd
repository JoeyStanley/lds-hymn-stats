...
The latest pattern is the huge spike on December 1st with <hymn>Come, Lord Jesus (#1018)</hymn>. The lyrics in the first first do mention the manger, so it makes sense. It's interesting to see a hymn that previously was not sung very often suddenly gain some popularity.
