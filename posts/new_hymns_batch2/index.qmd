...
However, we're now seven weeks since the release of the second batch, and it's clear that people are warming up to them. Late October was the peak popularity. Now that we're getting into Thanksgiving (in the US) and Christmas, those holidays will take precedent and we'll see fewer new hymns (except of course the new Christmas ones). In January, once the next batch is scheduled to come out, I think we'll see that third batch becoming more popular than either of the other two for a while.
