...
Since Christmas, the number of wards singing new hymns hasn't quite returned to its pre-Thanksgiving numbers, but it seems like people are swapping out hymns from the first batch and are going back to singing from the second batch a little more again. As we'll see below, a lot of this is wards singing <hymn>Amazing Grace (#1010)</hymn> again.
