...
Those numbers may seem low, but keep in mind that wards are unlikely to repeat these hymns too often. So, at best, hymns can only be a small percentage of the total number of sacrament meetings since their release. The fact that <hymn>Come, Thou Fount of Every Blessing (#1001)</hymn> is as high as it is is still pretty remarkable. It means, each week, on average about one or two wards in every stake have sung it. It's also around three times as popular as any of the other hymns. To put it another way, it's as popular as the next most common four hymns combined. 
...
```{r, include = TRUE, warning = FALSE, message = FALSE, fig.height = 5, fig.width = 8}
meetings_since_release |> 
    filter(hymn_num > 1000) |>  
...
For example, <hymn>It Is Well with My Soul (1003)</hymn> has increased since it's initial release. <hymn>As Bread is Broken (#1007)</hymn> was very popular on June 16th, Father's day. A common trend was to sing Father's Day songs for opening and closing hymns and that hymn as the sacrament hymn. 

## When during meetings are these hymns sung?

We can see when these hymns tend to be sung and get an overall look at the popularity of the first batch of hymns. If a new hymn is sung, it's likely to be done so as a closing hymn, with the exception of new sacrament hymns. <hymn>Come, Thou Fount of Every Blessing (#1001)</hymn> is often an opening hymn still, but something like <hymn>It Is Well with My Soul (1003)</hymn> is much more likely to be a closing hymn. At the time of writing, <hymn>I Will Walk with Jesus (#1004)</hymn> is the only hymn that is most commonly an intermediate hymn. 
