...
description: "What hymn has the highest melody note? What is a typical highest note for a sopranot line? What is the lowest highest note for a melody? If you can only sing up to a C, what proportion of hymns would you be able to sing melody on?"
author: "Joey Stanley"
date: "10/06/2023"
categories:
  - melody
...
![](../images/highest_soprano_notes.jpeg)

```{r, echo = FALSE, warning = FALSE, message=FALSE}
library(tidyverse)
read_csv("/Users/joeystan/Desktop/Projects/Hymns/data/cleaned_notes_data.csv", 
...
![](../images/soprano_E5.jpeg){#tab-soprano-E5}
...
![](../images/soprano_Db5.jpeg)

I think there are relatively few that have this particular note simply because of [what key signatures are most common](../posts/key_signatures.qmd). It's probably not a coincidence that one of the two hymns in D♭ are in this category. Most of the others are in A♭. If there were more hymns in D♭ major, or even A♭ we might see more hymns where the highest note is D♭5.  
...
![](../images/soprano_C5.jpeg)


There are five hymns don't ever go higher than the middle of the treble clef. The two that only go to a B4 are both pretty well known: <hymn>Secret Prayer (144)</hymn> and <hymn>Lead, Kindly Light (197)</hymn>. The only one that has B♭4 as the highest note is for men, <hymn>Ye Who Are Called to Labor (321)</hymn>, so it might not even count as a "soprano" note. Finally, two hymns have A♭4 as the highest note, the rare <hymn>God Moves in a Mysterious Way (285)</hymn> and the extremely rare <hymn>Now the Day is Over (159)</hymn>. These are low enough that even a good tenor could sing the melody in the right octave! In total, there are just 41 hymns that don't reach a D, which is only 12\% of the hymnal. But these 41 hymns account for 14.4\% of the hymns sung in sacrament meeting, which means you're likely to encounter one of them about every two weeks. So, if you don't have a very high range, at least a couple times a month, you're likely to be able to sing melody. 

## Summary

The highest note in the soprano line is an F♯5. About half of the hymns go up to D5, with many more going a little higher than that. Fewer never reach a D5. The lowest highest note in the soprano line is an A♭4. For what it's worth, I rarely sing melody because I have trouble hitting a D, so I personally would appreciate it if many of these hymns were transposed down a little bit. 