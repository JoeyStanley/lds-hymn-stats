...
Given what was discussed previously about the [sacrament hymns](/posts/sacrament.qmd), it shouldn't come as a surprise that the most common hymn is a sacrament hymn. There is a fairly well-enforced constraint that at least one hymn per meeting "must" be one of the 28 canonical sacrament hymns (with two ["honorary hymns"](/posts/sacrament.qmd#non-sacrament-hymns) as possibilities as well). We can now better appreciate the list of the most common hymns.

## The most common hymns

The most common hymns sung in the church, according to my data, are displayed in @fig-the-favorites. Here, sacrament hymns are in gray and other hymns are in black. I've shown only the hymns that are sung, on average, one or more times per year per ward.[You may think that a lot of hymns that pertain to specific holidays would make it onto this list, but as we'll see in later blog posts about annual trends, there are actually relatively few festive hymns that are sung by most wards most years.]{.aside} We see a nice list of 22 hymns that are probably well-known by most members of the church. They are generic enough to be appropriate for most meetings. Their message is centered on Christ and other foundational tenents of our religion. Some are more common around certain holidays, like *Come, Come Ye Saints (30)* around Pioneer Day in Utah or *Love At Home (294)* around Mother's Day, but they're also general enough to be appropriate at other times of the year as well. Thus, what we see in @fig-the-favorites is a solid list of the most popular hymns in the Church of Jesus Christ of Latter-day Saints.

![The "favorites": Hymns that are sung at least once per year](../images/the_favorites.jpeg){#fig-the-favorites}


@fig-the-favorites also shows how common each of these hymns are. Many sacrament hymns are sung, on average, more than twice a year. (Keep in mind that there are only 48 sacrament meetings per year, and 28 sacrament hymns to choose from, so many will have to double up.) None of the non-sacrament hymns were sung, on average, more than twice a year. But the sheer fact that this plot exists---a display of all the hymns thare are sung at least once a year on average---means that some wards do sing them more than once a year. 
