...
Also, keep in mind that some wards in this dataset do in fact systematically cycle through all the sacrament hymns. I recalculated the numbers without those wards, and the common hymns were slightly more frequent and the uncommon ones were even rarer. For example, *O Thou, Before the World Began (189)* jumped down from once every two years to once every three years.

### Non-sacrament hymns

Once in a while, a ward will indeed sing some other hymn as a sacrament hymn. Many hymns were selected by at least one ward at least one time, but two stood out. They are *O Savior, Thou Who Wearest a Crown (197)* and *Gently Raise the Sacred Strain (146)*. There is good reason for why these two were sung as sacrament hymns: if you look up "Sacrament" in the topical index in the back of the hymnal, it is a list of all the hymns from 169--196, but it also includes these two. 
